...
impl<TUintTraits: UintTraits> NoGenericArgsGenericType for UintType<TUintTraits> {
    ...
    const SIZE: i16 = 1; // TODO(yg): unrelated to this PR - is this right???
}
...
impl<TUintTraits: UintTraits> NoGenericArgsGenericLibfunc for UintDivModNLibfunc<TUintTraits> {
    const STR_ID: &'static str = TUintTraits::DIV_MOD_N;
    ...
    fn specialize_signature(
        ...
        Ok(LibfuncSignature::new_non_branch_ex(
            ...
            SierraApChange::Known { new_vars_only: true }, // TODO(yg)
        ))
    }
}
...
impl UintTraits for Uint8Traits {
    ...
    const DIV_MOD_N: &'static str = "u8_div_mod_n";
}
...
impl UintTraits for Uint16Traits {
    ...
    const DIV_MOD_N: &'static str = "u16_div_mod_n";
}
...
impl UintTraits for Uint32Traits {
    ...
    const DIV_MOD_N: &'static str = "u32_div_mod_n";
}
...
impl UintTraits for Uint64Traits {
    ...
    const DIV_MOD_N: &'static str = "u64_div_mod_n";
}
